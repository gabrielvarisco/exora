...
import { getTokenBySymbol, getTokensForChain } from "@/lib/tokens";
...
export default function SwapCard() {
  ...
  // sincroniza o analyzer com a rede da wallet
  useEffect(() => {
  ...
  // saldo correto do token selecionado na chain selecionada
